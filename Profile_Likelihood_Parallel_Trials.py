...
def scan_boundary(boundaries, params, destination_folder, param_profile, trial):
    global RMSE_CH
    global RMSE_ACH
    global RMSE_AP
    global RMSE_peaks
...
def run_experiment(methods, boundaries, destination_folder, params, params_profile, trial):
    start = timer()
    print(str(trial) + ' started ')
    for method in methods:
        params['method'] = method
        for param_profile in params_profile:
            df_optimized = scan_boundary(boundaries, params, destination_folder, param_profile, trial)
...
def run_parallel(methods, boundaries, destination_folder, params, params_to_profile):
    # PARALLEL
    Parallel(n_jobs=10)(delayed(run_experiment)(methods, boundaries, destination_folder, params, params_to_profile, trial)
